...
class Problem:
    ...
    def report(self):
        print()
        print("Average number of evaluations: {0:,}".format(self._avgNumEval[0]))
...
#        self._dx = 10 ** (-4)
    ...
    def report(self):
        print()
        print("Average objetive value : {0:,}".format(self._avgMinimum))
...
class Tsp(Problem):
    ...
    def report(self):
        print()
        print("Avg tour cost : {0:}".format(round(self._avgMinimum[0])))
        #print("Avg tour cost : {0:}".format(self._avgMinimum))
        print("Best of best order of visits:")
        #self.tenPerRow(self._solution)       # Print 10 cities per row
        self.tenPerRow()
        print("Best minimum tour cost: {0:,}".format(round(self._bestMinimum[0])))
        #print("Best minimum tour cost: {0:,}".format(self._bestMinimum))
        Problem.report(self)
